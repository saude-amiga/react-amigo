  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="md:hidden absolute right-0 mt-2 w-64 max-h-[80vh] overflow-y-auto bg-white border border-[#76b99d] rounded-md shadow-lg z-40">
          <nav className="p-4 space-y-2 text-[#194737] font-medium">
            ...
            <Link to="/saude-amiga" className="block px-4 py-2 rounded hover:bg-[#76b99d] hover:text-white transition">Sobre</Link>
      ...
      <div className="hidden md:flex justify-end p-4 space-x-4 z-30 text-white font-medium">
        ...
        <Link to="/quem-somos" className="px-4 py-2 rounded-md bg-[#194737] hover:bg-[#29966a] transition">Integrantes</Link>
        <Link to="/saude-amiga" className="px-4 py-2 rounded-md bg-[#194737] hover:bg-[#29966a] transition">Sobre</Link>
