    ...
    <main className="bg-white text-[#194737]">
      <section id="oficina" className="max-w-6xl mx-auto px-4 py-10 space-y-16">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          <img src={oficina1}alt="Adultos participando de oficina de inclusão digital"
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-8">
          <img src={oficina2} alt="Mulher usando headset e óculos explicando algo durante um atendimento remoto"
            className="w-full lg:w-1/2 h-auto rounded shadow-md"/>
          <div className="space-y-4">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          <img src={oficina3} alt="Homem mais velho sorrindo enquanto segura um smartphone"
            className="w-full lg:w-1/2 h-auto rounded shadow-md"/>
          <div className="space-y-4">
